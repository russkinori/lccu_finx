...
We collect and process financial data, including:
- Account balances
...
### 4.1 Within LCCU
We share information internally on a need-to-know basis:
- Administrators have access to user management data
- Principals have access to school-level financial data
- Teachers have access to class-level data
- Tellers have access to transaction processing data

### 4.2 Third-Party Service Providers
We may share information with trusted third parties who assist us in:
- Data storage and hosting (Supabase)
...
- Protect the rights, property, or safety of LCCU, users, or others
...
Contact LCCU administrators to exercise these rights.
...
- Location tracking (via device settings)
